document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('submit', function (e) {
    ...
    fields.forEach(function (field) {
      ...
      if (type === 'tel' || field.dataset.validate === 'tel') {
      ...
      const minLength = field.dataset.minlength || field.minLength;
      if (minLength && minLength > 0 && value.length < parseInt(minLength, 10)) {
  ...
  function handleFormSuccess(form) {
    ...
    successEl.textContent = form.dataset.successMessage || 'Thank you! Your message has been sent.';
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "ליובאוויטשער רופן- טיולים ובידור מכל הלב משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '4b3a1a03-c16f-4ba0-8e91-6a41f7258196',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '4b3a1a03-c16f-4ba0-8e91-6a41f7258196';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4b3a1a03-c16f-4ba0-8e91-6a41f7258196';
